...
local Window = OrionLib:MakeWindow({Name = "KAIDO HUB", HidePremium = false, IntroText = "KAIDO HUB", SaveConfig = true, ConfigFolder = "KAIDO HUB"})
...
OrionLib:MakeNotification({
	Name = "KAIDO HUB",
	Content = "KAIDO HUB Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
